...
- **Pesagem e mês**: todo domingo 09:00 ela pede o peso de todo mundo (fica em `pesagens`, com data). Dia 1 às 08:00 sai o relatório do mês anterior no grupo e em `Resumos/Mes-YYYY-MM.md`. `!hoje` mostra os totais do dia sem gastar IA; `!silencio 2h` a segura fora do papo; `!apelido` fixa ou tira o apelido.
