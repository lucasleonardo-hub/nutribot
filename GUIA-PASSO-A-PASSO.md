...
- **Voz** (`!voz`): quem liga recebe em áudio a resposta a um áudio que mandou, e o resumo do dia sai falado. Síntese pelo msedge-tts (grátis, não oficial) e conversão pelo ffmpeg-static. `VOZ_TTS` troca a voz.
